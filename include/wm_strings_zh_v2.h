// Project localization of WiFiManager 2.0.17 strings; upstream MIT header retained.
/**
 * wm_strings_en.h
 * engligh strings for
...
#ifndef _WM_STRINGS_ZH_V2_H_
#define _WM_STRINGS_ZH_V2_H_
...
"<form action='/0wifi'   method='get'><button>手动配置网络</button></form><br/>\n", // MENU_WIFINOSCAN
...
const char HTTP_FORM_WIFI[]        PROGMEM = "<label for='s'>网络名称</label><input id='s' name='s' maxlength='32' autocorrect='off' autocapitalize='none' placeholder='{v}'><br/><label for='p'>网络密码</label><input id='p' name='p' maxlength='64' type='password' placeholder='{p}'><input type='checkbox' id='showpass' onclick='f()'> <label for='showpass'>显示密码</label><br/>";
...
const char HTTP_SAVED[]            PROGMEM = "<div class='msg'>正在保存网络配置<br/>请在设备的连接状态中查看结果。<br/>若未连接，请重新进入手机配网。</div>";
const char HTTP_PARAMSAVED[]       PROGMEM = "<div class='msg S'>已保存<br/></div>";
const char HTTP_END[]              PROGMEM = "</div></body></html>";
const char HTTP_ERASEBTN[]         PROGMEM = "<br/><form action='/erase' method='get'><button class='D'>清除网络配置</button></form>";
...
const char HTTP_STATUS_ON[]        PROGMEM = "<div class='msg S'><strong>已连接</strong> {v}<br/><em><small>地址 {i}</small></em></div>";
const char HTTP_STATUS_OFF[]       PROGMEM = "<div class='msg {c}'><strong>未连接</strong> {v}{r}</div>"; // {c=class} {v=ssid} {r=status_off}
const char HTTP_STATUS_OFFPW[]     PROGMEM = "<br/>密码验证失败"; // STATION_WRONG_PASSWORD,  no eps32
const char HTTP_STATUS_OFFNOAP[]   PROGMEM = "<br/>未找到无线网络";   // WL_NO_SSID_AVAIL
const char HTTP_STATUS_OFFFAIL[]   PROGMEM = "<br/>无法连接"; // WL_CONNECT_FAILED
const char HTTP_STATUS_NONE[]      PROGMEM = "<div class='msg'>尚未配置网络</div>";
...
const char HTTP_HELP[]             PROGMEM =
 ...
 "<tr><td>/erase</td>"
 "<td>清除网络配置uration and reboot device. Device will not reconnect to a network until new WiFi configuration data is entered.</td></tr>"
 "</table>"
...
const char S_enable[]             PROGMEM = "开启";
const char S_disable[]            PROGMEM = "关闭";
const char S_GET[]                PROGMEM = "GET";
const char S_POST[]               PROGMEM = "POST";
const char S_NA[]                 PROGMEM = "未知";
const char S_passph[]             PROGMEM = "********";
const char S_titlewifisaved[]     PROGMEM = "网络配置已保存";
const char S_titlewifisettings[]  PROGMEM = "设置已保存";
const char S_titlewifi[]          PROGMEM = "配置无线网络";
...
const char S_nonetworks[]         PROGMEM = "未找到无线网络，请重新扫描。";
const char S_staticip[]           PROGMEM = "固定地址";
const char S_staticgw[]           PROGMEM = "网关";
const char S_staticdns[]          PROGMEM = "域名服务器";
const char S_subnet[]             PROGMEM = "子网掩码";
const char S_exiting[]            PROGMEM = "正在退出配网";
const char S_resetting[]          PROGMEM = "设备即将重启。";
const char S_closing[]            PROGMEM = "可关闭此页面，配网仍在运行";
